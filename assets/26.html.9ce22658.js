import{_ as e,a as i}from"./zsxq.01e272d6.js";import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as c,c as t,a as n,b as s,d as p,e as o,r as u}from"./app.175adf91.js";const d={},r=o(`<h2 id="java-中的「与运算-」-规则-都为-1-时才为-1-否则为-0" tabindex="-1"><a class="header-anchor" href="#java-中的「与运算-」-规则-都为-1-时才为-1-否则为-0" aria-hidden="true">#</a> Java 中的「与运算 &amp; 」 规则 ：都为 1 时才为 1，否则为 0</h2><ul><li>即：两位同时为 “1”，结果才为 “1”，否则为 0</li></ul><p>例如：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CeshiQuFan</span> <span class="token punctuation">{</span>
   ...
   */</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>欢迎关注我公众号：AI悦创，有更多更好玩的等你发现！</p><details class="custom-container details"><summary>公众号：AI悦创【二维码】</summary><p><img src="`+i+'" alt="" loading="lazy"></p></details>',24),v={class:"custom-container info"},m=n("p",{class:"custom-container-title"},"AI悦创·编程一对一",-1),k=n("p",null,"AI悦创·推出辅导班啦，包括「Python 语言辅导班、C++ 辅导班、java 辅导班、算法/数据结构辅导班、少儿编程、pygame 游戏开发」，全部都是一对一教学：一对一辅导 + 一对一答疑 + 布置作业 + 项目实践等。当然，还有线下线上摄影课程、Photoshop、Premiere 一对一教学、QQ、微信在线，随时响应！微信：Jiabcdefh",-1),b=n("p",null,"C++ 信息奥赛题解，长期更新！长期招收一对一中小学信息奥赛集训，莆田、厦门地区有机会线下上门，其他地区线上。微信：Jiabcdefh",-1),h={href:"http://wpa.qq.com/msgrd?v=3&uin=1432803776&site=qq&menu=yes",target:"_blank",rel:"noopener noreferrer"},g=n("p",null,"方法二：微信：Jiabcdefh",-1),_=n("p",null,[n("img",{src:e,alt:"",loading:"lazy"})],-1);function y(f,j){const a=u("ExternalLinkIcon");return c(),t("div",null,[r,n("div",v,[m,k,b,n("p",null,[s("方法一："),n("a",h,[s("QQ"),p(a)])]),g]),_])}const J=l(d,[["render",y],["__file","26.html.vue"]]);export{J as default};
