<template><div><p><img src="@source/code1v1.assets/02.png" alt="02" loading="lazy"></p>
<p><img src="@source/code1v1.assets/01.png" alt="01" loading="lazy"></p>
<h2 id="平时讲课比较忙-没时间写具体的课程计划-加微信咨询-jiabcdefh" tabindex="-1"><a class="header-anchor" href="#平时讲课比较忙-没时间写具体的课程计划-加微信咨询-jiabcdefh" aria-hidden="true">#</a> 平时讲课比较忙，没时间写具体的课程计划，加微信咨询：Jiabcdefh</h2>
