<template><div><p>该文件包含 AI悦创网站及其文章、专栏的所有显着更改，前面更新未记录。那今天开始记录。</p>
<h2 id="升级前的配置「2022-11-02-10-09-52」" tabindex="-1"><a class="header-anchor" href="#升级前的配置「2022-11-02-10-09-52」" aria-hidden="true">#</a> 升级前的配置「2022-11-02 10:09:52」</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>yarn.lock.txt</strong></p>
<p><a href="/website-copy/2022-11-02-10-09-52/yarn.lock.txt">yarn.lock.txt</a></p>
<ul>
<li>添加 哔哩哔哩、YouTube 视频播放</li>
<li>代码块修复</li>
</ul>
<h2 id="添加网站更改日志-2022-06-15-21-01-21" tabindex="-1"><a class="header-anchor" href="#添加网站更改日志-2022-06-15-21-01-21" aria-hidden="true">#</a> <RouterLink to="/changelog.html">添加网站更改日志</RouterLink> (2022-06-15 21:01:21)</h2>
<h3 id="features" tabindex="-1"><a class="header-anchor" href="#features" aria-hidden="true">#</a> Features</h3>
<ul>
<li>Add <a href="http://Changelog.md" target="_blank" rel="noopener noreferrer">Changelog.md<ExternalLinkIcon/></a></li>
<li>MD 播放视频</li>
<li>视频播放代码，不适合放进博客首页摘要，容易出现报错！</li>
</ul>
<details class="custom-container details"><summary>代码</summary>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>iframe</span> 
