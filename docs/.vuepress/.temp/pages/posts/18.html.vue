...
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>python3 -m venv venv
...
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>source venv/bin/activate
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>pip install wheel
...
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>sudo pip install wheel setuptools twine
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>pip install pytest
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>from TuringRobots import TuringRobots
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">from</span> setuptools <span class="token keyword">import</span> find_packages<span class="token punctuation">,</span> setup
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>python setup<span class="token punctuation">.</span>py pytest
...
<blockquote>
<p>下面是简单的代码测试输出：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token punctuation">(</span>venv<span class="token punctuation">)</span> aiyc@aiyc<span class="token punctuation">:</span><span class="token operator">~</span><span class="token operator">/</span>Linux_Code<span class="token operator">/</span>mypythonlibrary$ python setup<span class="token punctuation">.</span>py pytest
running pytest
running egg_info
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>python setup<span class="token punctuation">.</span>py bdist_wheel
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>pip install <span class="token operator">/</span>path<span class="token operator">/</span>to<span class="token operator">/</span>wheelfile<span class="token punctuation">.</span>whl
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> mypythonlib
...
<p>我自己使用如下官方构建：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>python3 <span class="token operator">-</span>m pip install <span class="token operator">-</span><span class="token operator">-</span>upgrade build
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>python3 <span class="token operator">-</span>m build
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><hr>
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code># 测试代码
