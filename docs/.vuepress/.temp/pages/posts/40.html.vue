...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>➜  <span class="token class-name">Desktop</span> java
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>➜  <span class="token class-name">Desktop</span> java <span class="token operator">--</span>version
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>➜  <span class="token class-name">Desktop</span> javac <span class="token operator">--</span>version
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>javac <span class="token class-name">QuickSand</span><span class="token punctuation">.</span>java
...
<p>运行 Java ：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>java <span class="token class-name">QuickSand</span>
