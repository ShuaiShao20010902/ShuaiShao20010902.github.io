...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>python3 <span class="token operator">-</span>m venv venv
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>创建后，你现在必须使用以下命令激活环境：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>source venv<span class="token operator">/</span><span class="token builtin">bin</span><span class="token operator">/</span>activate
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>PS：Windows</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>venv\Scripts\activate
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">from</span> mypythonlib <span class="token keyword">import</span> myfunctions
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>setup<span class="token punctuation">(</span>
    name<span class="token operator">=</span><span class="token string">'mypythonlib'</span><span class="token punctuation">,</span>
