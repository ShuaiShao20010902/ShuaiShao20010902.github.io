...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>rating_sum <span class="token operator">=</span> np<span class="token punctuation">.</span>zeros<span class="token punctuation">(</span><span class="token number">10000</span><span class="token punctuation">)</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> rating <span class="token keyword">in</span> data<span class="token punctuation">:</span>
