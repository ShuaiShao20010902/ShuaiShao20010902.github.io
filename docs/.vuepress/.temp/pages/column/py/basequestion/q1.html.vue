...
<p>语句 <code v-pre>x, y, z = 1, 2, 3</code> 执行后，变量 y 的值为__<em>_____</em>_。</p>
<blockquote>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>a = 'ABC'
b = a
a = 'XYZ'
print(b)
