...
<h2 id="课程受众" tabindex="-1"><a class="header-anchor" href="#课程受众" aria-hidden="true">#</a> 课程受众</h2>
<p><strong>0编程基础</strong>
编程语言基本概念不懂没关系，本课程会全程覆盖，详细讲解。</p>
<h2 id="java-能做什么" tabindex="-1"><a class="header-anchor" href="#java-能做什么" aria-hidden="true">#</a> Java 能做什么？</h2>
<ul>
<li><strong>AndroidApp</strong></li>
<li><strong>网站后台</strong></li>
<li><strong>系统后台</strong></li>
<li><strong>大数据</strong></li>
<li><strong>桌面工具</strong></li>
</ul>
<h2 id="编程简介" tabindex="-1"><a class="header-anchor" href="#编程简介" aria-hidden="true">#</a> 编程简介</h2>
<ul>
<li>编程就是让计算机按自己的意思去工作</li>
<li>编程语言就是一种计算机能“理解”的语言。</li>
</ul>
<h2 id="课程覆盖内容" tabindex="-1"><a class="header-anchor" href="#课程覆盖内容" aria-hidden="true">#</a> 课程覆盖内容</h2>
<table>
<thead>
<tr>
<th>01</th>
