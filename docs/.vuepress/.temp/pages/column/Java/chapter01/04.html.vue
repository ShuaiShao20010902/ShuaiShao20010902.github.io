<template><div><h2 id="_1-本节知识点" tabindex="-1"><a class="header-anchor" href="#_1-本节知识点" aria-hidden="true">#</a> 1. 本节知识点</h2>
<ul>
<li>计算加减乘除</li>
<li>基本数据类型——int</li>
<li>关键字（key word）和标示符（Identifier）</li>
<li>用变量解决问题</li>
</ul>
<h2 id="_2-创建新项目" tabindex="-1"><a class="header-anchor" href="#_2-创建新项目" aria-hidden="true">#</a> 2. 创建新项目</h2>
<p><img src="@source/column/Java/chapter01/04.assets/1654698727529-507da71e-7ae6-4f5d-baa7-6eae27b31ab7.png" alt="image.png" loading="lazy"></p>
<p><img src="@source/column/Java/chapter01/04.assets/1654698738738-71982a64-4ab4-4fe2-a0b3-3038506cf445.png" alt="image.png" loading="lazy"></p>
<blockquote>
<p>我选择的是 This Window</p>
</blockquote>
<h2 id="_3-新建-class" tabindex="-1"><a class="header-anchor" href="#_3-新建-class" aria-hidden="true">#</a> 3. 新建 class</h2>
<p><img src="@source/column/Java/chapter01/04.assets/1654699545975-f16d4e1e-f773-44ac-abf8-731a1909aa6e.png" alt="image.png" loading="lazy"></p>
<p><img src="@source/column/Java/chapter01/04.assets/1654699886809-1405a000-ed6e-496f-829c-9ec197074f9e.png" alt="image.png" loading="lazy"></p>
<p><img src="@source/column/Java/chapter01/04.assets/1654699999737-2317991d-7715-4f7a-9a86-04797cc5ba14.png" alt="image.png" loading="lazy"></p>
<h2 id="_4-编写代码" tabindex="-1"><a class="header-anchor" href="#_4-编写代码" aria-hidden="true">#</a> 4. 编写代码</h2>
<p>计算加减乘除的程序（例程 MathCalc）</p>
<ul>
<li>字面值（literalvalue）写几就是几</li>
<li>加减乘除运算符</li>
</ul>
<p><strong>如何方便的计算类似</strong> <code v-pre>y=a*x+b*x*x+c*x*x*x</code> <strong>这样的公式?</strong></p>
<h3 id="_4-1-mathcalc-java" tabindex="-1"><a class="header-anchor" href="#_4-1-mathcalc-java" aria-hidden="true">#</a> 4.1 MathCalc.java</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MathCalc</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MathCalc</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Q：上面的代码确实可以实现，但是不方便我们修改呀。比如：我们要把其中的 5 换成其他数字呢？——显然不是非常方便。</strong></p>
<p><strong>显然，我要修改至少 6 个 5，这显然劝退我了。</strong></p>
<p><strong>为了解决这个问题，我们该怎么办呢？</strong></p>
<h3 id="_4-2-基本数据类型——int【variable-java】" tabindex="-1"><a class="header-anchor" href="#_4-2-基本数据类型——int【variable-java】" aria-hidden="true">#</a> 4.2 基本数据类型——int【Variable.java】</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Variable</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>现在我们修改 9 就很方便了，直接修改 x 即可。</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Variable</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">int</span> a <span class="token operator">=</span> <span class="token number">3</span><span class="token punctuation">;</span>
        <span class="token keyword">int</span> b <span class="token operator">=</span> <span class="token number">5</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>知识点解析一波：</strong>
Java 中所有的数据都有类型，类型决定了存储的形式和占用的存储空间。举个例子：</p>
<ul>
<li>微博</li>
<li>博客</li>
<li>连载小说</li>
</ul>
<p>int 用来表示一个整数，取值范围在 <code v-pre>-2^31~2^31-1</code>。计算出来是 <code v-pre>-2147483648~2147483647</code>。</p>
<h2 id="_5-关键字-key-word-和标示符-identifier" tabindex="-1"><a class="header-anchor" href="#_5-关键字-key-word-和标示符-identifier" aria-hidden="true">#</a> 5. 关键字（key word）和标示符（Identifier）</h2>
<h3 id="_5-1-标示符" tabindex="-1"><a class="header-anchor" href="#_5-1-标示符" aria-hidden="true">#</a> 5.1 标示符</h3>
<ul>
<li>由大小写英文字符，数字和下划线(<code v-pre>_</code>)组成的，区分大小写的，不以数字开头的文字。</li>
<li>可以用作 Java 中的各种东西的名字，比如类名，方法名等。</li>
<li>标示符是区分大小写的。</li>
</ul>
<p><strong>关键字是 Java 语法的保留字，不能用来做名字。</strong></p>
<p><strong>我们接触到的关键字：</strong></p>
<ul>
...
<h2 id="_6-用变量解决问题" tabindex="-1"><a class="header-anchor" href="#_6-用变量解决问题" aria-hidden="true">#</a> 6. 用变量解决问题</h2>
<p><strong>例程 Variable1</strong></p>
<ul>
<li>变量（variable）</li>
<li>如何创建变量</li>
<li>如何给变量一个值</li>
...
<h3 id="_6-1-例程-variable1" tabindex="-1"><a class="header-anchor" href="#_6-1-例程-variable1" aria-hidden="true">#</a> 6.1 例程 Variable1</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Variable1</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token comment">//        System.out.println(b=101);</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="小技巧" tabindex="-1"><a class="header-anchor" href="#小技巧" aria-hidden="true">#</a> 小技巧</h2>
<ol>
<li>快捷输入 <code v-pre>public static void main(String[] args)</code>，在 IDE 中使用：psvm 既可以快速输入；</li>
</ol>
