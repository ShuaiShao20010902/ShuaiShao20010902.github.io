<template><div><h2 id="前端开发主要技术介绍" tabindex="-1"><a class="header-anchor" href="#前端开发主要技术介绍" aria-hidden="true">#</a> 前端开发主要技术介绍</h2>
<p>在学习前端开发之前呢，大家肯定或多或少，听说过一些前端开发的技术名词。它们到底是什么呢？这节课我来给你们答疑一下。</p>
<ul>
<li>HTML5：搭建网页结构的语言，增加了很多移动端的支持，简单好学。「HTML5 也是我们课程最先学习的语言」</li>
<li>CSS3：样式表，美化网页的语言，增加了很多动画、过渡等新特性，要记得英语单词非常多，不过非常有意思。</li>
<li>JavaScript：前端开发工程师最重要的“看家语言”，JS 功底的好坏，决定了职业高度，学习需要下苦功。</li>
<li>Vue.js / React.js：从 2016 年前后开始流行的前端框架，采用模块化开发、数据驱动、声明式编程，只需要前期“马步扎稳”，后面“武功招式”随便学。</li>
</ul>
