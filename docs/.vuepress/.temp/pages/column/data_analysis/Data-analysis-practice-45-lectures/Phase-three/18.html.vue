...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>CART分类树准确率 <span class="token number">0.9600</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token punctuation">[</span><span class="token string">'CRIM'</span> <span class="token string">'ZN'</span> <span class="token string">'INDUS'</span> <span class="token string">'CHAS'</span> <span class="token string">'NOX'</span> <span class="token string">'RM'</span> <span class="token string">'AGE'</span> <span class="token string">'DIS'</span> <span class="token string">'RAD'</span> <span class="token string">'TAX'</span> <span class="token string">'PTRATIO'</span> <span class="token string">'B'</span> <span class="token string">'LSTAT'</span><span class="token punctuation">]</span>
