...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span><span class="token punctuation">></span></span>My first SVG<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><button name="button" style="color: black"><a href="https://bornforthis.cn/web_runing/svg/README/README.html" target="_blank">尝试一下</a></button></p>
<p><strong>点击 &quot;尝试一下&quot; 按钮查看运行结果.</strong></p>
<h2 id="svg-实例" tabindex="-1"><a class="header-anchor" href="#svg-实例" aria-hidden="true">#</a> SVG 实例</h2>
<p>我们可以在线编辑 SVG 实例，并且在线查看运行结果!</p>
<p><a href="#">在线实例</a>待更新</p>
<h2 id="svg-参考手册" tabindex="-1"><a class="header-anchor" href="#svg-参考手册" aria-hidden="true">#</a> SVG 参考手册</h2>
<p>在菜鸟教程中， 我们为您提供完整的 SVG 参考手册，其中列出了所有 W3C 推荐标准（SVG Version 1.1）中的 SVG 的元素。</p>
<p><a href="#">SVG 参考手册</a>待更新</p>
<p><a href="https://bornforthis.cn/svg/index.html" target="_blank" rel="noopener noreferrer">SVG 在线编辑器<ExternalLinkIcon/></a></p>
