...
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>pip install xlwt
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> xlwt
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>sheet <span class="token operator">=</span> wb<span class="token punctuation">.</span>add_sheet<span class="token punctuation">(</span><span class="token string">'第一个sheet'</span><span class="token punctuation">)</span>
...
<p>另外两种写入方法：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> index<span class="token punctuation">,</span> head <span class="token keyword">in</span> <span class="token builtin">enumerate</span><span class="token punctuation">(</span>head_data<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>pip install faker
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> faker
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>wb.save('虚假用户数据.xls')
...
<div class="language-cmd line-numbers-mode" data-ext="cmd"><pre v-pre class="language-cmd"><code>pip install xlrd
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>sheets <span class="token operator">=</span> wb<span class="token punctuation">.</span>sheets<span class="token punctuation">(</span><span class="token punctuation">)</span>  <span class="token comment"># 获取文件中全部的 sheet，返回结构是 list。</span>
...
<p>取出总行数和列数的代码如下：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>rows <span class="token operator">=</span> sheet<span class="token punctuation">.</span>nrows  <span class="token comment"># 行</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> row <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span>rows<span class="token punctuation">)</span><span class="token punctuation">:</span>
