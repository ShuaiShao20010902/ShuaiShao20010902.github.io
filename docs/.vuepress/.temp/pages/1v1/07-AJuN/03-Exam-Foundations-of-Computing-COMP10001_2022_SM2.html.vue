<template><div><p>This assignment is locked until Nov 1 at 15:00.</p>
<blockquote>
<p>此作业锁定到11月1日15:00。</p>
</blockquote>
<h2 id="question-1" tabindex="-1"><a class="header-anchor" href="#question-1" aria-hidden="true">#</a> Question 1</h2>
<h3 id="a-output-value-wombat" tabindex="-1"><a class="header-anchor" href="#a-output-value-wombat" aria-hidden="true">#</a> (a) Output value: <code v-pre>'wombat'</code></h3>
<p>Required operations:</p>
<ol>
<li><code v-pre>.join()</code> method</li>
<li>list slicing</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">22</span><span class="token punctuation">]</span><span class="token punctuation">:</span> <span class="token string">""</span><span class="token punctuation">.</span>join<span class="token punctuation">(</span><span class="token builtin">list</span><span class="token punctuation">(</span><span class="token string">'waobmcbdaet'</span><span class="token punctuation">)</span><span class="token punctuation">[</span><span class="token punctuation">:</span><span class="token punctuation">:</span><span class="token number">2</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="b-output-value-true" tabindex="-1"><a class="header-anchor" href="#b-output-value-true" aria-hidden="true">#</a> (b) Output value: True</h3>
<p>Required operations:</p>
<ol>
<li>len() function</li>
<li>dictionary lookup</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token builtin">len</span><span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token number">1</span><span class="token punctuation">:</span><span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span><span class="token number">2</span><span class="token punctuation">,</span><span class="token number">3</span><span class="token punctuation">]</span><span class="token punctuation">}</span><span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token operator">==</span> <span class="token number">3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="c-output-value-6-3-2" tabindex="-1"><a class="header-anchor" href="#c-output-value-6-3-2" aria-hidden="true">#</a> (c) Output value: '6 // 3 == 2!'</h3>
<p>Required operations:</p>
<ol>
<li>floor division</li>
<li>f-string</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token string-interpolation"><span class="token string">f'</span><span class="token interpolation"><span class="token punctuation">{</span><span class="token number">12</span><span class="token operator">//</span><span class="token number">2</span><span class="token punctuation">}</span></span><span class="token string"> // 3 == 2'</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="d-output-value-1" tabindex="-1"><a class="header-anchor" href="#d-output-value-1" aria-hidden="true">#</a> (d) Output value: 1</h3>
<p>Required operations:</p>
<ol>
<li><code v-pre>.pop()</code> method</li>
<li><code v-pre>.split()</code> method</li>
<li><code v-pre>.index()</code> method</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token string">"1,2,3"</span><span class="token punctuation">.</span>split<span class="token punctuation">(</span><span class="token string">","</span><span class="token punctuation">)</span><span class="token punctuation">.</span>index<span class="token punctuation">(</span><span class="token string">"2"</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">.</span>pop<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="e-output-value-true" tabindex="-1"><a class="header-anchor" href="#e-output-value-true" aria-hidden="true">#</a> (e) Output value:  True</h3>
<p>Required operations:</p>
<ol>
<li><code v-pre>.keys()</code> method</li>
<li>in operator</li>
<li>tuple indexing</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token builtin">tuple</span><span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">:</span> <span class="token string">"value"</span><span class="token punctuation">}</span><span class="token punctuation">.</span>keys<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span> <span class="token keyword">in</span> <span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="question-2" tabindex="-1"><a class="header-anchor" href="#question-2" aria-hidden="true">#</a> Question 2</h2>
<p>An ngram is a sequence of symbols (such as characters) of length n. Each string can be represented as a sequence of n-grams. For example, <code v-pre>'cat'</code> can be represented as <code v-pre>'c'</code>, <code v-pre>'a'</code>, <code v-pre>'t'</code> (1-grams, or unigrams), or as <code v-pre>'c'</code>,<code v-pre> 'ca'</code>, <code v-pre>'at'</code>, <code v-pre>'t'</code> (2-grams, or bigrams). [Note that the first bigram of the word <code v-pre>'cat'</code> is <code v-pre>'c'</code>, i.e., a space and c, and the last bigram of the word <code v-pre>'cat'</code> is <code v-pre>'t'</code>, i.e., t and a space.]</p>
<blockquote>
<p>一个 ngram 是长度为 n 的符号序列(如字符)。每个字符串都可以表示为 n 个 gram 的序列。例如，<code v-pre>'cat'</code> 可以表示为 <code v-pre>'c'</code>， <code v-pre>'a'</code>， <code v-pre>'t'</code> (1克，或字母组合)，或表示为 <code v-pre>'c'</code>， <code v-pre>'ca'</code>， <code v-pre>'at'</code>， <code v-pre>'t'</code> (2克，或字母组合)。[请注意，单词 “cat” 的第一个重音是 “c”，即一个空格和 c，单词 “cat” 的最后一个重音是 “t”，即 t 和一个空格。]</p>
</blockquote>
<p>The function <code v-pre>most_freq_ngrams(_file, nglen=1)</code> takes a file name _file and the ngram length nglen, processes the file, and returns the top 5 most common ngrams that have at least one symbol specified in the global variable PHONEMES.</p>
<blockquote>
<p>函数 <code v-pre>most_freq_ngrams(_file, nglen=1)</code> 接受文件名_file和ngram长度nglen，处理该文件，并返回在全局变量phoneme中至少有一个符号的前5个最常见的ngram。</p>
</blockquote>
<p>The input file contains poetry pieces as well as some empty lines or lines with auxiliary information (AABB, ABAB ... etc.). Here is a sample input file (Q2poems.txt):</p>
<blockquote>
<p>输入文件包含诗歌片段以及一些空行或带有辅助信息的行(AABB, ABAB…等等)。下面是一个示例输入文件(Q2poems.txt):</p>
</blockquote>
<p><strong>Q2poems.txt</strong></p>
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="language-txt"><code>ABAB
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The function reads the file line by line skipping empty lines as well as those that only contain a single word (assuming words are separated by a whitespace character).</p>
<blockquote>
<p>该函数通过跳过空行和只包含一个单词的行(假设单词由空格字符分隔)来读取文件行。</p>
</blockquote>
<p>For example,</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token operator">>></span><span class="token operator">></span> most_freq_ngrams<span class="token punctuation">(</span><span class="token string">'Q2poems.txt'</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>As presented, the lines of the function are out of order in the window to the right. Put the lines in the correct order and introduce appropriate indentation. Note that as an additional constraint, your code must follow PEP8 and should not produce any PEP8 warnings when run.</p>
<blockquote>
<p>如图所示，在右边的窗口中，函数的行顺序是乱的。把线条按正确的顺序排列，并引入适当的缩进。注意，作为一个附加约束，您的代码必须遵循PEP8，并且在运行时不应该产生任何PEP8警告。</p>
</blockquote>
<p>Note: A Counter is a dict subclass, it is a collection where elements are stored as dictionary keys and their counts are stored as dictionary values. most_common(n) returns a list of the n most common elements and their counts from the most common to the least.</p>
<blockquote>
<p>注意: Counter 是一个 dict 子类，它是一个集合，其中元素被存储为字典键，它们的计数被存储为字典值。Most_common(n)返回n个最常见元素的列表，以及它们从最常见到最不常见的计数。</p>
</blockquote>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>PHONEMES <span class="token operator">=</span> <span class="token string">'iauoe'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/1v1/07-AJuN/03-Exam-Foundations-of-Computing-COMP10001_2022_SM2.assets/image-20221101121000208.png" alt="image-20221101121000208" loading="lazy"></p>
<h3 id="答案" tabindex="-1"><a class="header-anchor" href="#答案" aria-hidden="true">#</a> 答案</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">from</span> collections <span class="token keyword">import</span> Counter
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">'__main__'</span><span class="token punctuation">:</span>
    ...
    <span class="token keyword">print</span><span class="token punctuation">(</span>r<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="question-3" tabindex="-1"><a class="header-anchor" href="#question-3" aria-hidden="true">#</a> Question 3</h2>
<p>In this question, we will play with a new form of poetry. In this form of poetry, each line of the poem should follow a specified format, in terms of containing a sequence of short and long words. The function provided here is designed to check whether a given poem follows the provided format.</p>
<blockquote>
<p>在这个问题中，我们将玩转一种新的诗歌形式。在这种形式的诗歌中，诗的每一行都应该遵循特定的格式，即包含一系列长短词。这里提供的函数旨在检查给定的诗歌是否遵循所提供的格式。</p>
</blockquote>
<p>The format for a line in a poem is specified by a string of the characters <code v-pre>'S'</code> (for short words) and <code v-pre>'L'</code> (for long words). For example, the format <code v-pre>'SSL'</code> specifies that the corresponding line of the poem should contain 3 words: a short word, followed by another short word, followed by a long word. We will consider a word with 3 characters or less to be a short word, otherwise it is considered a long word. The line of poetry 'a big balloon' satisfies the format <code v-pre>'SSL'</code>, while none of the lines 'one big dog', 'advance australia fair' or 'tomorrow for dinner' satisfy the format <code v-pre>'SSL'</code>.</p>
<blockquote>
<p>诗中一行的格式由一串字符“S”(用于短词)和“L”(用于长词)指定。例如，“SSL”格式指定诗歌的对应行应该包含3个单词:一个短单词，后面跟着另一个短单词，后面跟着一个长单词。我们会认为一个少于3个字符的单词是短单词，否则它被认为是长单词。“一个大气球”这一行诗满足“SSL”的格式，而“一只大狗”、“推进澳大利亚博览会”或“明天的晚餐”这几行诗都不满足“SSL”的格式。</p>
</blockquote>
<p>The format for a poem is given as a list of strings, where each string represents the format of the corresponding line of the poem. For example, <code v-pre>['SSSL', 'LL', 'SLS']</code> is the format for poems containing 3 lines, where the first line has the format <code v-pre>'SSSL'</code>, and so on. An example of a poem that matches this format is:</p>
<blockquote>
<p>一首诗的格式是一个字符串列表，其中每个字符串代表诗中相应行的格式。例如，[' ssl '， 'LL'， 'SLS']是包含3行诗的格式，其中第一行的格式为' ssl '，以此类推。一个符合这种格式的诗歌例子是:</p>
</blockquote>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>I saw a crocodile
Smiling strangely
But rather fat
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This poem can be represented as a single string, with each line separated by a newline character <code v-pre>\n</code>, for example, 'I saw a crocodile\nSmiling strangely\nBut rather fat'. Each word contains only letters, and words in a line are separated by whitespace.</p>
<blockquote>
<p>这首诗可以表示为单行，每行之间用换行字符“n”隔开，例如，“我看到一条鳄鱼\n微笑得很奇怪\n但很胖”。每个单词只包含字母，一行中的单词用空格分隔。</p>
</blockquote>
<p>The function <code v-pre>check_poem(poem, structure)</code> takes as input a poem and its format specification, and returns either <code v-pre>True</code> or <code v-pre>False</code>. The <code v-pre>True</code> value is returned if the poem matches the given format, otherwise it should return <code v-pre>False</code>.</p>
<blockquote>
<p>函数check_poem(poem, structure)接受一首诗及其格式规范作为输入，并返回True或False。如果诗歌匹配给定的格式，则返回True值，否则返回False值。</p>
</blockquote>
<ul>
<li><code v-pre>poem</code> - a non-empty string comprising lines separated by <code v-pre>\n</code> that represents a poem.</li>
<li><code v-pre>structure</code> - a list of strings representing the correct format of a poem.</li>
</ul>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">check_poem</span><span class="token punctuation">(</span>poem<span class="token punctuation">,</span> structure<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="question-4" tabindex="-1"><a class="header-anchor" href="#question-4" aria-hidden="true">#</a> Question 4</h2>
<p>for 编程 while</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">make_pack</span><span class="token punctuation">(</span>weights<span class="token punctuation">,</span> _max<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="答案-1" tabindex="-1"><a class="header-anchor" href="#答案-1" aria-hidden="true">#</a> 答案</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">make_pack</span><span class="token punctuation">(</span>weights<span class="token punctuation">,</span> _max<span class="token punctuation">)</span><span class="token punctuation">:</span>
    weights<span class="token punctuation">.</span>sort<span class="token punctuation">(</span><span class="token punctuation">)</span>
    ...
    <span class="token keyword">while</span> index <span class="token operator">&lt;</span> <span class="token builtin">len</span><span class="token punctuation">(</span>weights<span class="token punctuation">[</span><span class="token punctuation">:</span><span class="token punctuation">:</span><span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
        ...
        <span class="token keyword">if</span> item <span class="token operator">&lt;=</span> remaining<span class="token punctuation">:</span>
            ...
            remaining <span class="token operator">=</span> remaining <span class="token operator">-</span> item
    <span class="token keyword">return</span> pack
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="学员答案" tabindex="-1"><a class="header-anchor" href="#学员答案" aria-hidden="true">#</a> 学员答案</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">make_pack</span><span class="token punctuation">(</span>weights<span class="token punctuation">,</span> _max<span class="token punctuation">)</span><span class="token punctuation">:</span>
    weights<span class="token punctuation">.</span>sort<span class="token punctuation">(</span><span class="token punctuation">)</span>
    ...
    <span class="token keyword">for</span> item <span class="token keyword">in</span> weights<span class="token punctuation">[</span><span class="token punctuation">:</span><span class="token punctuation">:</span><span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">]</span><span class="token punctuation">:</span>
        <span class="token keyword">if</span> item <span class="token operator">&lt;=</span> remaining<span class="token punctuation">:</span>
            ...
            remaining <span class="token operator">=</span> remaining <span class="token operator">-</span> item
    <span class="token keyword">return</span> pack
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="question-5" tabindex="-1"><a class="header-anchor" href="#question-5" aria-hidden="true">#</a> Question 5</h2>
<p>Esperanto is one of the most widely used constructed languages. Unlike many natural languages, it is considered to be easy to learn as it has high regularity. For instance, the suffixes ‑o, ‑a, ‑e, and ‑i indicate that a word is a noun (kato, a cat), adjective (bela, beautiful), adverb (bele, beautifully), and infinitive verb (paroli, to speak), respectively. It has a single definite article (la) and a set of pronouns (mi, ni, vi, li, ŝi, ĝi, ili). Plural forms of nouns and adjectives are formed by attaching j as in katoj (cats).</p>
<blockquote>
<p>世界语是使用最广泛的构造语言之一。与许多自然语言不同，它被认为很容易学习，因为它有很高的规律性。例如，后缀o、a、e和i分别表示一个单词是名词(kato，一只猫)、形容词(bela，美丽)、副词(bele，美丽)和不定式动词(paroli，说话)。它有一个定冠词(la)和一组代词(mi, ni, vi, li， ŝi, i, ili)。名词和形容词的复数形式是通过在katoj (cats)中加上j来形成的。</p>
</blockquote>
<p>The sentence structure is very much like English (Subject–Verb–Object) while objects are additionally marked by the n suffix (La hundo amas la katon, the dog loves the cat).</p>
<blockquote>
<p>这句话的句子结构很像英语(主语-动词-宾语)，而宾语则附加了n后缀(La hundo amas La katon，狗爱猫)。</p>
</blockquote>
<p>Verbs tenses are also expressed via endings: -is, -as, -os for the past, present, future tense, respectively. E.g., estas means is, ĉasis— chased, esperos— will hope. Finally, negation is expressed via the ne particle.</p>
<blockquote>
<p>动词的时态也可以通过结尾来表达:-is， -as， -os分别用于过去时，现在时和将来时。例如，estas的意思是“是”、“是”、“是”、“是”。最后，否定通过ne粒子来表达。</p>
</blockquote>
<p>Here are some sample sentences and their English translations:</p>
<blockquote>
<p>下面是一些例句和它们的英文翻译:</p>
</blockquote>
<ul>
<li>La floro estas bela //  The flower is beautiful</li>
</ul>
<blockquote>
<p>La floro estas bela //这朵花很漂亮</p>
</blockquote>
<ul>
<li>La kato ne kuris //     The cat didn't run</li>
</ul>
<blockquote>
<p>灵魂使者不跟猫咪跑</p>
</blockquote>
<ul>
<li>Ŝi havas belajn florojn // She has beautiful flowers</li>
</ul>
<blockquote>
<p>Ŝi havas belajn florojn //她有漂亮的花</p>
</blockquote>
<ul>
<li>Kato kuris // A cat ran</li>
</ul>
<blockquote>
<p>Kato kuris //一只猫跑了</p>
</blockquote>
...
<blockquote>
<p>该代码的目的是将世界语句子作为输入，并返回句子中每个单词的词性(动词、名词、……)的列表。词类(词类)作为字典pos提供，其中包含标记，表示每个词类和对应的词类。标记要么是名词、动词、形容词、副词以“-”开头的1-3个字符的后缀，要么是代词、冠词、助词的2-3个字符的完整单词)。函数process(text)接受字符串文本并返回词性列表。它首先尝试匹配整个单词的单位，然后是后缀(从最长的开始)。如果它没有找到匹配的字符串，它就将相应的单词分配给OOV(词汇表外)。</p>
</blockquote>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">process</span><span class="token punctuation">(</span>text<span class="token punctuation">)</span><span class="token punctuation">:</span>                              <span class="token comment"># 1</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token operator">>></span><span class="token operator">></span> process<span class="token punctuation">(</span><span class="token string">'La floro estas bela'</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>However, there are several errors in the given function definitions. Identify <strong>exactly</strong> three (3) errors and specify:</p>
<blockquote>
<p>然而，在给定的函数定义中有几个错误。确定<strong>准确</strong>三(3)个错误并指定:</p>
</blockquote>
<p>(a) the line where the error occurs;</p>
<blockquote>
<p>(a)发生错误的线;</p>
</blockquote>
<p>(b) the type of error, as <em>syntax</em>, <em>run-time</em>, or logic; and</p>
<blockquote>
<p>(b)错误类型，如<em>语法</em>、<em>运行时</em>或逻辑;和</p>
</blockquote>
<p>(c) how you would fix each error, in the form of the corrected (single) line of code.</p>
<blockquote>
<p>(c)你们将如何以纠正的(单)行代码的形式修正每个错误。</p>
</blockquote>
<h3 id="答案-2" tabindex="-1"><a class="header-anchor" href="#答案-2" aria-hidden="true">#</a> 答案</h3>
<ol>
<li>12 行的 for 缺少冒号 <code v-pre>:</code></li>
<li>10、15 tuple 没有 append，把 3行改成列表。</li>
</ol>
<h2 id="question-6" tabindex="-1"><a class="header-anchor" href="#question-6" aria-hidden="true">#</a> Question 6</h2>
<p>The following function csvdict<code v-pre>(filename)</code> is intended to read a csv file with the given filename. The first line of the csv file contains the headings of each column in the file. Each subsequent line of the csv file contains an integer value for each column. You can assume that the csv file exists, is correctly formatted, it contains at least one column, it has at least one row of values in addition to the heading row, and each row has the correct number of values.</p>
<blockquote>
<p>下面的函数csvdict ' (filename) '用于读取具有给定文件名的csv文件。csv文件的第一行包含文件中每个列的标题。csv文件的后续每一行都包含每个列的整数值。您可以假设csv文件存在，格式正确，至少包含一列，除标题行外至少有一行值，并且每行值的数量正确。</p>
</blockquote>
<p>The function csvdict<code v-pre>(filename)</code> should return a dictionary, whose keys correspond to the headings of the columns in the csv file, and the value of each key is the integer sum of the values of the corresponding column.</p>
<blockquote>
<p>函数 <code v-pre>csvdict'(filename)'</code> 应该返回一个字典，它的键对应于 csv 文件中列的标题，每个键的值是对应列值的整数和。</p>
</blockquote>
<p>For example, if the csv file test <code v-pre>.csv</code> contains:</p>
<blockquote>
<p>例如，如果 csv 文件test ' .csv '包含:</p>
</blockquote>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>col1<span class="token punctuation">,</span> col2<span class="token punctuation">,</span> col3
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>then csvdict<code v-pre>('test.csv')</code> will return:</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token punctuation">{</span><span class="token string">'col1'</span><span class="token punctuation">:</span> <span class="token number">30</span><span class="token punctuation">,</span> <span class="token string">'col2'</span><span class="token punctuation">:</span> <span class="token number">9</span><span class="token punctuation">,</span> <span class="token string">'col3'</span><span class="token punctuation">:</span> <span class="token number">313</span><span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Provide code to insert into each of the numbered boxes in the code below to complete the function as described. Note that your code will be evaluated at the indentation level indicated for each box.</p>
<blockquote>
<p>提供代码，将其插入到下面代码中的每个编号框中，以完成所述的功能。请注意，您的代码将在每个框所指示的缩进级别上计算。</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/1v1/07-AJuN/03-Exam-Foundations-of-Computing-COMP10001_2022_SM2.assets/image-20221101122727959.png" alt="image-20221101122727959" loading="lazy"></p>
<h3 id="答案-3" tabindex="-1"><a class="header-anchor" href="#答案-3" aria-hidden="true">#</a> 答案</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> csv
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">'__main__'</span><span class="token punctuation">:</span>
    ...
    <span class="token keyword">print</span><span class="token punctuation">(</span>r<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="question-7" tabindex="-1"><a class="header-anchor" href="#question-7" aria-hidden="true">#</a> Question 7</h2>
<p>Write a function brackets_match<code v-pre>(instring)</code> that takes a string as input, and returns True if all the brackets in instring match correctly, or False otherwise. You can assume that the input string contains only digits (i.e., '0123456789') and brackets (i.e., '(' and ')').</p>
<blockquote>
<p>编写一个函数 brackets_match(instring)，它接受一个字符串作为输入，如果instring中的所有方括号都正确匹配则返回 True，否则返回False。您可以假设输入字符串只包含数字(即'0123456789')和括号(即'('和')')。</p>
</blockquote>
<p>The brackets in the string are considered to match correctly if for every opening bracket '(' there is a matching closing bracket ')' later in the string, and conversely every closing bracket has a matching opening bracket earlier in the string.</p>
<blockquote>
<p>如果字符串中后面的每个开始括号'('有一个匹配的结束括号')'，则认为字符串中的括号是正确匹配的，相反，每个结束括号在字符串中较早的时候都有一个匹配的开始括号。</p>
</blockquote>
<p>Note that digits can appear anywhere in the string but can be ignored, and instring will always contain one or more brackets.</p>
<blockquote>
<p>注意，数字可以出现在字符串中的任何位置，但可以忽略，instring 将始终包含一个或多个方括号。</p>
</blockquote>
<p>For example:</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token operator">>></span><span class="token operator">></span> brackets_match<span class="token punctuation">(</span><span class="token string">'()'</span><span class="token punctuation">)</span>
...
<span class="token boolean">False</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="答案-4" tabindex="-1"><a class="header-anchor" href="#答案-4" aria-hidden="true">#</a> 答案</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">brackets_match</span><span class="token punctuation">(</span>instring<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="question-8" tabindex="-1"><a class="header-anchor" href="#question-8" aria-hidden="true">#</a> Question 8</h2>
<p>Write a function digisum<code v-pre>(num)</code> that takes a positive integer as its input num, and returns an integer containing a single digit, which is calculated as follows:</p>
<blockquote>
<p>编写一个函数 digisum ' (num) '，它接受一个正整数作为输入num，并返回一个包含单个数字的整数，其计算方法如下:</p>
</blockquote>
<ul>
<li>Your function should add up the digits  in num.</li>
</ul>
<blockquote>
<p>函数应该将num中的数字相加。</p>
</blockquote>
<ul>
<li>If the resulting sum is in the range 0 to 9, i.e., the sum has a single digit, then return that sum.</li>
</ul>
<blockquote>
<p>如果结果的和在0到9的范围内，也就是说，这个和只有一个数字，那么返回这个和。</p>
</blockquote>
<ul>
<li>Otherwise, the resulting sum has more than  one digit, so you need to repeat the process by adding up the digits in     the resulting sum.</li>
</ul>
<blockquote>
<p>否则，得到的和有不止一个数字，因此您需要通过将得到的和中的数字相加来重复这个过程。</p>
</blockquote>
<ul>
<li>You need to keep repeating the process of calculating a new sum by adding up the digits in the previous sum until you reach a sum that has a single digit.</li>
</ul>
<blockquote>
<p>你需要不断重复计算一个新的和的过程，将前一个和中的数字相加，直到得到一个只有一个数字的和。</p>
</blockquote>
<p>For example, if the input num is 8979, the sum of its digits is 8+ 9+7+9=33. Since this sum has more than one digit, we repeat by calculating the sum of its digits 3 + 3 = 6. Since this new sum has a single digit, we return the new sum 6.</p>
<blockquote>
<p>例如，如果输入的数字是 8979，则其数字的和为 8+ 9+7+9=33。因为这个和不止一个数字，我们重复计算它的数字3 + 3 = 6的和。因为这个新的和只有一位数字，所以我们返回新的和6。</p>
</blockquote>
<p>Similarly, if the input num is 999999999999993, the return value is 3, since 9+9+9+9+9+9+9+9+9+9+9+9+9+9+3 = 129, and 1+2+9 = 12, and 1+2 = 3.</p>
<blockquote>
<p>类似地，如果输入数字为999999999999993，则返回值为3，因为9+9+9+9+9+9+9+9+9+9+9+9+9+9+3 = 129,1+2+9 = 12,1+2 = 3。</p>
</blockquote>
<p>For example:</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token operator">>></span><span class="token operator">></span> digisum<span class="token punctuation">(</span><span class="token number">8979</span><span class="token punctuation">)</span>
...
<span class="token number">6</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="答案-5" tabindex="-1"><a class="header-anchor" href="#答案-5" aria-hidden="true">#</a> 答案</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">parse</span><span class="token punctuation">(</span>num<span class="token punctuation">)</span><span class="token punctuation">:</span>
