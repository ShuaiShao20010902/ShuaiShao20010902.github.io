<template><div><nav class="table-of-contents"><ul><li><router-link to="#_10-字符串「dannie」">10-字符串「Dannie」</router-link></li><li><router-link to="#_1-字符串定义">1. 字符串定义</router-link></li><li><router-link to="#_2-为什么会有三种创建字符串的方法">2. 为什么会有三种创建字符串的方法？</router-link><ul><li><router-link to="#_2-1-单双引号混用">2.1 单双引号混用</router-link></li><li><router-link to="#_2-2-三个双引号-or-三个单引号「原样输出」">2.2 三个双引号 or 三个单引号「原样输出」</router-link></li><li><router-link to="#_2-3-代码实操">2.3 代码实操</router-link></li></ul></li><li><router-link to="#_3-获取字符串长度-len">3. 获取字符串长度 len</router-link></li><li><router-link to="#_4-字符串数据提取">4. 字符串数据提取</router-link><ul><li><router-link to="#_4-1-单个字符提取">4.1 单个字符提取</router-link></li><li><router-link to="#_4-2-提取多个数据">4.2 提取多个数据</router-link></li><li><router-link to="#_4-3-有间隔的提取数据-start-end-间隔">4.3 有间隔的提取数据 [start: end: 间隔]</router-link></li><li><router-link to="#_4-4-如果知道是从开始到结尾的话-开始和结尾可以省略不写">4.4 如果知道是从开始到结尾的话，开始和结尾可以省略不写</router-link></li><li><router-link to="#_4-5-字符串倒序">4.5 字符串倒序</router-link></li><li><router-link to="#_4-6-代码练习">4.6 代码练习</router-link></li></ul></li><li><router-link to="#_5-字符串的内置函数">5. 字符串的内置函数</router-link><ul><li><router-link to="#_5-1-capitalize">5.1 capitalize()</router-link></li><li><router-link to="#_5-2-count">5.2 count()</router-link></li><li><router-link to="#_5-3-startswith">5.3 startswith()</router-link></li><li><router-link to="#提示-ipython-是用上面字符串">提示：ipython 是用上面字符串</router-link></li><li><router-link to="#_5-4-endswith">5.4 endswith()</router-link></li><li><router-link to="#_5-5-find">5.5 find()</router-link></li><li><router-link to="#_5-6-index">5.6 index()</router-link></li><li><router-link to="#_5-7-rfind">5.7 rfind()</router-link></li><li><router-link to="#_5-8-rindex">5.8 rindex()</router-link></li><li><router-link to="#_5-9-isalpha">5.9 isalpha()</router-link></li><li><router-link to="#_5-10-isdigit">5.10 isdigit()</router-link></li><li><router-link to="#_5-11-join">5.11 join()</router-link></li><li><router-link to="#_5-12-lower">5.12 lower()</router-link></li><li><router-link to="#_5-13-upper">5.13 upper()</router-link></li><li><router-link to="#_5-14-strip">5.14 strip()</router-link></li><li><router-link to="#_5-15-replace">5.15 replace()</router-link></li></ul></li><li><router-link to="#_6-字符串不可变性">6.字符串不可变性</router-link></li><li><router-link to="#_7-字符串的不可变性">7. 字符串的不可变性</router-link></li><li><router-link to="#_8-字符串的转译">8. 字符串的转译</router-link></li><li><router-link to="#_9-字符串的连接">9. 字符串的连接</router-link></li><li><router-link to="#_10-用户输入">10. 用户输入</router-link></li><li><router-link to="#_11-input-的特点">11. input 的特点</router-link></li><li><router-link to="#_12-eval">12. eval()</router-link></li><li><router-link to="#_13-强制转换">13. 强制转换</router-link></li><li><router-link to="#_14-作业-创建一个问答式简历生成软件">14. 作业：创建一个问答式简历生成软件</router-link></li><li><router-link to="#_15-dannie-作业">15. Dannie 作业</router-link></li><li><router-link to="#_16-format">16. format</router-link><ul><li><router-link to="#_16-1-一个插入">16.1 一个插入</router-link></li><li><router-link to="#_16-2-两个位置">16.2 两个位置</router-link></li><li><router-link to="#_16-3-更像模版">16.3 更像模版？</router-link></li><li><router-link to="#_16-4-怕位置放反">16.4 怕位置放反？</router-link></li></ul></li><li><router-link to="#_17-f">17. f</router-link></li><li><router-link to="#_18">18. %</router-link></li><li><router-link to="#作业优化上节课的作业">作业优化上节课的作业</router-link></li><li><router-link to="#_19-保留小数点">19. 保留小数点</router-link></li></ul></nav>
<h2 id="_10-字符串「dannie」" tabindex="-1"><a class="header-anchor" href="#_10-字符串「dannie」" aria-hidden="true">#</a> 10-字符串「Dannie」</h2>
<h2 id="_1-字符串定义" tabindex="-1"><a class="header-anchor" href="#_1-字符串定义" aria-hidden="true">#</a> 1. 字符串定义</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20220929225254941.png" alt="image-20220929225254941" loading="lazy"></p>
<h2 id="_2-为什么会有三种创建字符串的方法" tabindex="-1"><a class="header-anchor" href="#_2-为什么会有三种创建字符串的方法" aria-hidden="true">#</a> 2. 为什么会有三种创建字符串的方法？</h2>
<h3 id="_2-1-单双引号混用" tabindex="-1"><a class="header-anchor" href="#_2-1-单双引号混用" aria-hidden="true">#</a> 2.1 单双引号混用</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"I'm lilei."</span>  <span class="token comment"># 单双引号混用</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>s<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-三个双引号-or-三个单引号「原样输出」" tabindex="-1"><a class="header-anchor" href="#_2-2-三个双引号-or-三个单引号「原样输出」" aria-hidden="true">#</a> 2.2 三个双引号 or 三个单引号「原样输出」</h3>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>AI悦创·编程一对一AI悦创·推出辅导班啦，
...
著作权归黄家宝<span class="token operator">|</span>AI悦创所有
原文链接：https<span class="token punctuation">:</span><span class="token operator">//</span>bornforthis<span class="token punctuation">.</span>cn<span class="token operator">/</span>1v1<span class="token operator">/</span><span class="token number">03</span><span class="token operator">-</span>Dannie<span class="token operator">/</span><span class="token number">10</span><span class="token punctuation">.</span>html
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-代码实操" tabindex="-1"><a class="header-anchor" href="#_2-3-代码实操" aria-hidden="true">#</a> 2.3 代码实操</h3>
<ol>
<li>输出如下结果：</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>Session was closed
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="dannie-代码" tabindex="-1"><a class="header-anchor" href="#dannie-代码" aria-hidden="true">#</a> Dannie 代码</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>a<span class="token operator">=</span><span class="token triple-quoted-string string">'''Session was closed
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>a<span class="token operator">=</span>"Session was closed\
Welcome to Ubuntu <span class="token number">18.04</span><span class="token number">.6</span> LTS <span class="token punctuation">(</span>GNU<span class="token operator">/</span>Linux <span class="token number">4.15</span><span class="token number">.0</span><span class="token operator">-</span><span class="token number">189</span><span class="token operator">-</span>generic x86_64<span class="token punctuation">)</span>\
\
 <span class="token operator">*</span> Documentation<span class="token punctuation">:</span>  https<span class="token punctuation">:</span><span class="token operator">//</span><span class="token builtin">help</span><span class="token punctuation">.</span>ubuntu<span class="token punctuation">.</span>com\
 <span class="token operator">*</span> Management<span class="token punctuation">:</span>     https<span class="token punctuation">:</span><span class="token operator">//</span>landscape<span class="token punctuation">.</span>canonical<span class="token punctuation">.</span>com\
...
<span class="token keyword">print</span><span class="token punctuation">(</span>a<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-获取字符串长度-len" tabindex="-1"><a class="header-anchor" href="#_3-获取字符串长度-len" aria-hidden="true">#</a> 3. 获取字符串长度 len</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20220930224633129.png" alt="image-20220930224633129" loading="lazy"></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"aiyuechuang"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token number">11</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_4-字符串数据提取" tabindex="-1"><a class="header-anchor" href="#_4-字符串数据提取" aria-hidden="true">#</a> 4. 字符串数据提取</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20220930232437098.png" alt="image-20220930232437098" loading="lazy"></p>
<h3 id="_4-1-单个字符提取" tabindex="-1"><a class="header-anchor" href="#_4-1-单个字符提取" aria-hidden="true">#</a> 4.1 单个字符提取</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"aiyuechuang"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="代码练习" tabindex="-1"><a class="header-anchor" href="#代码练习" aria-hidden="true">#</a> 代码练习</h4>
<p>提取字符串中的单个字符：</p>
<ol>
<li>y✅</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-2-提取多个数据" tabindex="-1"><a class="header-anchor" href="#_4-2-提取多个数据" aria-hidden="true">#</a> 4.2 提取多个数据</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"aiyuechuang"</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>select<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="代码练习-1" tabindex="-1"><a class="header-anchor" href="#代码练习-1" aria-hidden="true">#</a> 代码练习</h4>
<ol>
<li>aiyu</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s<span class="token operator">=</span><span class="token string">"aiyuechuang"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-有间隔的提取数据-start-end-间隔" tabindex="-1"><a class="header-anchor" href="#_4-3-有间隔的提取数据-start-end-间隔" aria-hidden="true">#</a> 4.3 有间隔的提取数据 [start: end: 间隔]</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"aiyuechuang"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>ayehag
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="代码练习-2" tabindex="-1"><a class="header-anchor" href="#代码练习-2" aria-hidden="true">#</a> 代码练习</h4>
<ol>
<li>iucun</li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s<span class="token operator">=</span><span class="token string">"aiyuechuang"</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>select<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4-如果知道是从开始到结尾的话-开始和结尾可以省略不写" tabindex="-1"><a class="header-anchor" href="#_4-4-如果知道是从开始到结尾的话-开始和结尾可以省略不写" aria-hidden="true">#</a> 4.4 如果知道是从开始到结尾的话，开始和结尾可以省略不写</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s<span class="token operator">=</span><span class="token string">"aiyuechuang"</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>select<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-5-字符串倒序" tabindex="-1"><a class="header-anchor" href="#_4-5-字符串倒序" aria-hidden="true">#</a> 4.5 字符串倒序</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"aiyuechuang"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>gnauhceuyia
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"aiyuechuang"</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>select<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-6-代码练习" tabindex="-1"><a class="header-anchor" href="#_4-6-代码练习" aria-hidden="true">#</a> 4.6 代码练习</h3>
<p><strong>操作目标字符串：</strong></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"Dannie Alex Jaden Austin AndersonHJB Cava"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol>
<li>提取：<code v-pre>D</code></li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">4</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie Alex Jaden Austin AndersonHJB Cava"</span>
...
<li>提取：<code v-pre>A</code></li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">6</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie Alex Jaden Austin AndersonHJB Cava"</span>
...
<li>提取：<code v-pre>Dan</code></li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">8</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie Alex Jaden Austin AndersonHJB Cava"</span>
...
<li>提取：<code v-pre>Alex</code></li>
</ol>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">10</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie Alex Jaden Austin AndersonHJB Cava"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">15</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie Alex Jaden Austin AndersonHJB Cava"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">19</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie Alex Jaden Austin AndersonHJB Cava"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="dannie-答案" tabindex="-1"><a class="header-anchor" href="#dannie-答案" aria-hidden="true">#</a> Dannie 答案</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">2</span><span class="token punctuation">]</span><span class="token punctuation">:</span> a<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span>
...
<h3 id="_5-1-capitalize" tabindex="-1"><a class="header-anchor" href="#_5-1-capitalize" aria-hidden="true">#</a> 5.1 capitalize()</h3>
<p><strong>作用：</strong> 「对字符串开头的第一个单词大写」</p>
<h4 id="ipython-实现运行" tabindex="-1"><a class="header-anchor" href="#ipython-实现运行" aria-hidden="true">#</a> ipython 实现运行</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">22</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s<span class="token punctuation">.</span>capitalize<span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<p>字符串本身不能被改变！！！需要得到最后改变的值，则需创建变量</p>
</blockquote>
<h4 id="pycharm-实现代码" tabindex="-1"><a class="header-anchor" href="#pycharm-实现代码" aria-hidden="true">#</a> pycharm 实现代码</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"dannie"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>Dannie
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5-2-count" tabindex="-1"><a class="header-anchor" href="#_5-2-count" aria-hidden="true">#</a> 5.2 count()</h3>
<p><strong>作用/功能：</strong> 某个字母或者单词出现的次数</p>
<h4 id="ipython-实现" tabindex="-1"><a class="header-anchor" href="#ipython-实现" aria-hidden="true">#</a> ipython 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">23</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s<span class="token punctuation">.</span>count<span class="token punctuation">(</span><span class="token string">"n"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="pycharm-实现" tabindex="-1"><a class="header-anchor" href="#pycharm-实现" aria-hidden="true">#</a> pycharm 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"dannie"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token number">2</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"dannieni"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token number">2</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5-3-startswith" tabindex="-1"><a class="header-anchor" href="#_5-3-startswith" aria-hidden="true">#</a> 5.3 startswith()</h3>
<p><strong>功能：</strong> 判断字符串开始是不是所查询的字母或者单词</p>
<h4 id="ipython-实现-1" tabindex="-1"><a class="header-anchor" href="#ipython-实现-1" aria-hidden="true">#</a> ipython 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">24</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s<span class="token punctuation">.</span>startswith<span class="token punctuation">(</span><span class="token string">"d"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="pycharm-实现-1" tabindex="-1"><a class="header-anchor" href="#pycharm-实现-1" aria-hidden="true">#</a> pycharm 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"dannieni"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token boolean">True</span>
<span class="token boolean">False</span>
<span class="token boolean">True</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="提示-ipython-是用上面字符串" tabindex="-1"><a class="header-anchor" href="#提示-ipython-是用上面字符串" aria-hidden="true">#</a> 提示：ipython 是用上面字符串</h3>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221002214450478.png" alt="image-20221002214450478" loading="lazy"></p>
<h3 id="_5-4-endswith" tabindex="-1"><a class="header-anchor" href="#_5-4-endswith" aria-hidden="true">#</a> 5.4 endswith()</h3>
<p><strong>功能：</strong> 判断字符串结尾的字母或者单词</p>
<h4 id="ipython-实现-2" tabindex="-1"><a class="header-anchor" href="#ipython-实现-2" aria-hidden="true">#</a> ipython 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">27</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s<span class="token punctuation">.</span>endswith<span class="token punctuation">(</span><span class="token string">"n"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="pycharm-实现-2" tabindex="-1"><a class="header-anchor" href="#pycharm-实现-2" aria-hidden="true">#</a> pycharm 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"dannieni"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token boolean">False</span>
<span class="token boolean">False</span>
<span class="token boolean">False</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-5-find" tabindex="-1"><a class="header-anchor" href="#_5-5-find" aria-hidden="true">#</a> 5.5 find()</h3>
<p><strong>功能：</strong> 寻找字符串中第一次出现的下标「字母或者单词都只会返回第一个出现的下标」<strong>如果没有找到的，则返回：-1</strong></p>
<h4 id="ipython-实现-3" tabindex="-1"><a class="header-anchor" href="#ipython-实现-3" aria-hidden="true">#</a> ipython 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">34</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="pycharm-实现-3" tabindex="-1"><a class="header-anchor" href="#pycharm-实现-3" aria-hidden="true">#</a> pycharm 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"Dannie"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token number">0</span>
<span class="token number">1</span>
<span class="token number">2</span>
<span class="token operator">-</span><span class="token number">1</span>
<span class="token number">3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-6-index" tabindex="-1"><a class="header-anchor" href="#_5-6-index" aria-hidden="true">#</a> 5.6 index()</h3>
<p><strong>功能：</strong> 查找字母或者单词第一个次出现的下标，<strong>如果没找到，则：报错</strong></p>
<h4 id="ipython-实现-4" tabindex="-1"><a class="header-anchor" href="#ipython-实现-4" aria-hidden="true">#</a> ipython 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">40</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"Dannie"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="pycharm-实现-4" tabindex="-1"><a class="header-anchor" href="#pycharm-实现-4" aria-hidden="true">#</a> pycharm 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"Dannie"</span>
...
<p>之后带你了解 find 与 index 的区别</p>
</blockquote>
<h3 id="_5-7-rfind" tabindex="-1"><a class="header-anchor" href="#_5-7-rfind" aria-hidden="true">#</a> 5.7 rfind()</h3>
<p><strong>rfind：</strong> 寻找字符串中，被查询的「字母或单词」最后一次出现的位置。</p>
<blockquote>
<p>Python rfind() 返回字符串最后一次出现的位置，如果没有匹配项则返回 -1。</p>
</blockquote>
<h4 id="ipython-实现-5" tabindex="-1"><a class="header-anchor" href="#ipython-实现-5" aria-hidden="true">#</a> ipython 实现</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="pycharm-实现-5" tabindex="-1"><a class="header-anchor" href="#pycharm-实现-5" aria-hidden="true">#</a> pycharm 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"aiyuechuang"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-8-rindex" tabindex="-1"><a class="header-anchor" href="#_5-8-rindex" aria-hidden="true">#</a> 5.8 rindex()</h3>
<p><code v-pre>rindex()</code> 返回子字符串 str 在字符串中最后出现的位置，如果没有匹配的字符串会报异常，你可以指定可选参数 <code v-pre>[beg:end]</code> 设置查找的区间。</p>
<h4 id="ipython-实现-6" tabindex="-1"><a class="header-anchor" href="#ipython-实现-6" aria-hidden="true">#</a> ipython 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>略<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="pycharm-实现-6" tabindex="-1"><a class="header-anchor" href="#pycharm-实现-6" aria-hidden="true">#</a> pycharm 实现</h4>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>str1 <span class="token operator">=</span> <span class="token string">"this is really a string example....wow!!!"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token number">5</span>
Traceback <span class="token punctuation">(</span>most recent call last<span class="token punctuation">)</span><span class="token punctuation">:</span>
  File <span class="token string">"test.py"</span><span class="token punctuation">,</span> line <span class="token number">6</span><span class="token punctuation">,</span> <span class="token keyword">in</span> <span class="token operator">&lt;</span>module<span class="token operator">></span>
    <span class="token keyword">print</span> <span class="token punctuation">(</span>str1<span class="token punctuation">.</span>rindex<span class="token punctuation">(</span>str2<span class="token punctuation">,</span><span class="token number">10</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
ValueError<span class="token punctuation">:</span> substring <span class="token keyword">not</span> found
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Dannie</strong></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>str1<span class="token operator">=</span><span class="token string">"this is really a string example....wow!!!"</span>
str2<span class="token operator">=</span><span class="token string">"is"</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>str1<span class="token punctuation">.</span>rindex<span class="token punctuation">(</span>str2<span class="token punctuation">)</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token number">5</span>
<span class="token number">5</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>就是从第三个字符开始查 is 所在的位置， 所以是第5</p>
</blockquote>
<h3 id="_5-9-isalpha" tabindex="-1"><a class="header-anchor" href="#_5-9-isalpha" aria-hidden="true">#</a> 5.9 isalpha()</h3>
<p>Python isalpha() 方法检测字符串是否只由<strong>字母</strong>或<strong>文字</strong>组成。</p>
...
<span class="token keyword">print</span> <span class="token punctuation">(</span><span class="token builtin">str</span><span class="token punctuation">.</span>isalpha<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上实例输出结果如下：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token boolean">True</span>
<span class="token boolean">True</span>
<span class="token boolean">False</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-10-isdigit" tabindex="-1"><a class="header-anchor" href="#_5-10-isdigit" aria-hidden="true">#</a> 5.10 isdigit()</h3>
<p>Python isdigit() 方法检测字符串是否只由数字组成。如果字符串只包含数字则返回 True 否则返回 False。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/python3</span>
...
<span class="token keyword">print</span> <span class="token punctuation">(</span><span class="token builtin">str</span><span class="token punctuation">.</span>isdigit<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上实例输出结果如下：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token boolean">True</span>
<span class="token boolean">False</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>isdigit() 方法只对正整数有效，负数及小数均返回不正确。</strong></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 判断是否为数字</span>
...
<span class="token boolean">True</span>
<span class="token boolean">False</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-11-join" tabindex="-1"><a class="header-anchor" href="#_5-11-join" aria-hidden="true">#</a> 5.11 join()</h3>
<p>Python <code v-pre>join()</code> 方法用于将序列中的元素以指定的字符连接生成一个新的字符串。返回通过指定字符连接序列中元素后生成的新字符串。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s1 <span class="token operator">=</span> <span class="token string">"-"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>b<span class="token operator">-</span>o<span class="token operator">-</span>r<span class="token operator">-</span>n<span class="token operator">-</span>f<span class="token operator">-</span>o<span class="token operator">-</span>r<span class="token operator">-</span>t<span class="token operator">-</span>h<span class="token operator">-</span>i<span class="token operator">-</span>s
bornforthis
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s1<span class="token operator">=</span><span class="token string">"$"</span>
s2<span class="token operator">=</span><span class="token string">"&amp;"</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>s1<span class="token punctuation">.</span>join<span class="token punctuation">(</span>seq<span class="token punctuation">)</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>s2<span class="token punctuation">.</span>join<span class="token punctuation">(</span>seq<span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>b$o$r$n$f$o$r$t$h$i$s
b<span class="token operator">&amp;</span>o<span class="token operator">&amp;</span>r<span class="token operator">&amp;</span>n<span class="token operator">&amp;</span>f<span class="token operator">&amp;</span>o<span class="token operator">&amp;</span>r<span class="token operator">&amp;</span>t<span class="token operator">&amp;</span>h<span class="token operator">&amp;</span>i<span class="token operator">&amp;</span>s
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-12-lower" tabindex="-1"><a class="header-anchor" href="#_5-12-lower" aria-hidden="true">#</a> 5.12 lower()</h3>
<p>Python lower() 方法转换字符串中所有大写字符为小写。返回将字符串中所有大写字符转换为小写后生成的字符串。</p>
<p>以下实例展示了lower()的使用方法：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>str1 <span class="token operator">=</span> <span class="token string">"Bornforthis EXAMPLE....WOW!!!"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上实例输出结果如下：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>bornforthis example<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>wow!!!
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s<span class="token operator">=</span><span class="token string">"DANNIE IS A GOOD GIRL"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-13-upper" tabindex="-1"><a class="header-anchor" href="#_5-13-upper" aria-hidden="true">#</a> 5.13 upper()</h3>
<p>Python upper() 方法将字符串中的小写字母转为大写字母。返回小写字母转为大写字母的字符串。</p>
<p>以下实例展示了 upper() 函数的使用方法：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>str1 <span class="token operator">=</span> <span class="token string">"this is string example from bornforthis....wow!!!"</span><span class="token punctuation">;</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>str1<span class="token punctuation">.</span>upper<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">:</span>  THIS IS STRING EXAMPLE FROM BORNFORTHIS<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>WOW!!!
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5-14-strip" tabindex="-1"><a class="header-anchor" href="#_5-14-strip" aria-hidden="true">#</a> 5.14 strip()</h3>
<p>Python strip() 方法用于移除字符串头尾指定的字符（默认为空格）或字符序列。</p>
<p>**注意：**该方法只能删除开头或是结尾的字符，不能删除中间部分的字符。</p>
<p>返回值：返回移除字符串头尾指定的字符序列生成的新字符串。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token string">"   aiyc    "</span>
...
new_s <span class="token operator">=</span> s<span class="token punctuation">.</span>strip<span class="token punctuation">(</span><span class="token string">"_"</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>new_s<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>aiyc
aiyc
 _aiyc_ 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-15-replace" tabindex="-1"><a class="header-anchor" href="#_5-15-replace" aria-hidden="true">#</a> 5.15 replace()</h3>
<p>replace() 方法把字符串中的 old（旧字符串） 替换成 new(新字符串)，如果指定第三个参数max，则替换不超过 max 次。</p>
<p><strong>replace() 方法语法：</strong></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token builtin">str</span><span class="token punctuation">.</span>replace<span class="token punctuation">(</span>old<span class="token punctuation">,</span> new<span class="token punctuation">[</span><span class="token punctuation">,</span> <span class="token builtin">max</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>参数</strong></p>
<ul>
<li>old -- 将被替换的子字符串。</li>
<li>new -- 新字符串，用于替换 old 子字符串。</li>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>new_s<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 请把 ATGCGGC  变成 CCCCCAA</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Dannie 的答案</strong></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s<span class="token operator">=</span><span class="token string">"ATGCGGC"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-字符串不可变性" tabindex="-1"><a class="header-anchor" href="#_6-字符串不可变性" aria-hidden="true">#</a> 6.字符串不可变性</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221006214532260.png" alt="image-20221006214532260" loading="lazy"></p>
<h2 id="_7-字符串的不可变性" tabindex="-1"><a class="header-anchor" href="#_7-字符串的不可变性" aria-hidden="true">#</a> 7. 字符串的不可变性</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221006215335396.png" alt="image-20221006215335396" loading="lazy"></p>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221006215606415.png" alt="image-20221006215606415" loading="lazy"></p>
<h2 id="_8-字符串的转译" tabindex="-1"><a class="header-anchor" href="#_8-字符串的转译" aria-hidden="true">#</a> 8. 字符串的转译</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221006215619011.png" alt="image-20221006215619011" loading="lazy"></p>
<h2 id="_9-字符串的连接" tabindex="-1"><a class="header-anchor" href="#_9-字符串的连接" aria-hidden="true">#</a> 9. 字符串的连接</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221007214030174.png" alt="image-20221007214030174" loading="lazy"></p>
<h2 id="_10-用户输入" tabindex="-1"><a class="header-anchor" href="#_10-用户输入" aria-hidden="true">#</a> 10. 用户输入</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221007214909714.png" alt="image-20221007214909714" loading="lazy"></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s <span class="token operator">=</span> <span class="token builtin">input</span><span class="token punctuation">(</span><span class="token string">"Please enter name:>>>"</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>s<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_11-input-的特点" tabindex="-1"><a class="header-anchor" href="#_11-input-的特点" aria-hidden="true">#</a> 11. input 的特点</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">]</span><span class="token punctuation">:</span> <span class="token builtin">type</span><span class="token punctuation">(</span><span class="token builtin">input</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
aiyc
...
<h2 id="_12-eval" tabindex="-1"><a class="header-anchor" href="#_12-eval" aria-hidden="true">#</a> 12. eval()</h2>
<blockquote>
<p><code v-pre>s=eval(input(s))</code> 是把输入的 s 的内容恢复到原来的类型</p>
<p>例如:
<code v-pre>s = eval(input())</code>
<code v-pre>print(type(s))</code>
输入： [1，2，，3]
输出： &lt;class 'list'&gt;</p>
</blockquote>
<blockquote>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">21</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s<span class="token operator">=</span><span class="token builtin">eval</span><span class="token punctuation">(</span><span class="token builtin">input</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/1v1/03-Dannie/10.assets/image-20221007222223619.png" alt="image-20221007222223619" loading="lazy"></p>
<h2 id="_13-强制转换" tabindex="-1"><a class="header-anchor" href="#_13-强制转换" aria-hidden="true">#</a> 13. 强制转换</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221007222944120.png" alt="image-20221007222944120" loading="lazy"></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">31</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"12"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">34</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token string">"19aaa"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">29</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s<span class="token operator">=</span><span class="token builtin">int</span><span class="token punctuation">(</span><span class="token number">1.1</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/1v1/03-Dannie/10.assets/image-20221007222714386.png" alt="image-20221007222714386" loading="lazy"></p>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221007222842394.png" alt="image-20221007222842394" loading="lazy"></p>
<h2 id="_14-作业-创建一个问答式简历生成软件" tabindex="-1"><a class="header-anchor" href="#_14-作业-创建一个问答式简历生成软件" aria-hidden="true">#</a> 14. 作业：创建一个问答式简历生成软件</h2>
<p><img src="@source/1v1/03-Dannie/10.assets/image-20221007223259036.png" alt="image-20221007223259036" loading="lazy"></p>
<h2 id="_15-dannie-作业" tabindex="-1"><a class="header-anchor" href="#_15-dannie-作业" aria-hidden="true">#</a> 15. Dannie 作业</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>name<span class="token operator">=</span><span class="token builtin">input</span><span class="token punctuation">(</span><span class="token string">"请输入您的姓名： "</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_16-format" tabindex="-1"><a class="header-anchor" href="#_16-format" aria-hidden="true">#</a> 16. format</h2>
<h3 id="_16-1-一个插入" tabindex="-1"><a class="header-anchor" href="#_16-1-一个插入" aria-hidden="true">#</a> 16.1 一个插入</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s<span class="token operator">=</span><span class="token string">"Hi AndersonJHB, Welcome to Beijing."</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>Hi Mason<span class="token punctuation">,</span> Welcome to Beijing<span class="token punctuation">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_16-2-两个位置" tabindex="-1"><a class="header-anchor" href="#_16-2-两个位置" aria-hidden="true">#</a> 16.2 两个位置</h3>
<p>如果这里把地点也设置成 <code v-pre>{}</code>，也可以这样实现：</p>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>Hi Mason<span class="token punctuation">,</span> Welcome to Cairns<span class="token punctuation">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_16-3-更像模版" tabindex="-1"><a class="header-anchor" href="#_16-3-更像模版" aria-hidden="true">#</a> 16.3 更像模版？</h3>
<p>我直接在这行代码后面 <code v-pre>.format{}</code> 并没有发挥代码的作用。（并没有发挥 format 的全部优点）</p>
<p>但是如果可以这样</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>sample_str<span class="token operator">=</span><span class="token string">"Hi {}, Welcome to {}."</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>Hi Mason<span class="token punctuation">,</span> Welcome to Cains<span class="token punctuation">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/1v1/03-Dannie/10.assets/image-20221009213510484.png" alt="image-20221009213510484" loading="lazy"></p>
<h3 id="_16-4-怕位置放反" tabindex="-1"><a class="header-anchor" href="#_16-4-怕位置放反" aria-hidden="true">#</a> 16.4 怕位置放反？</h3>
<p>因为 Mason 和 Cairns 如果位置发生变化， 那么输出也会发生变化。怎么办呢？</p>
<p>可以这样， 指定名字 name 和 地点 location</p>
<p>比如：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>sample_str<span class="token operator">=</span><span class="token string">"Hi {name}, Welcome to {location}."</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>sample1<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输出： Hi Mason, Welcome to Cains.</p>
<p>现在这样， 即使 name 和 location 换了位置， 都不用担心输出会变。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>sample_str<span class="token operator">=</span><span class="token string">"Hi {name}, Welcome to {location}."</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>Hi Mason<span class="token punctuation">,</span> Welcome to Cains<span class="token punctuation">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_17-f" tabindex="-1"><a class="header-anchor" href="#_17-f" aria-hidden="true">#</a> 17. f</h2>
<p>赋值</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>name<span class="token operator">=</span> <span class="token string">"Mason"</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>sample1<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输出： <code v-pre>Hi Mason, Welcome to Cairns.</code></p>
<p>注意 ：<code v-pre>sample1= f&quot;Hi {name}, Welcome to {location}.&quot;</code>  这里 有一个 <strong>f</strong></p>
<h2 id="_18" tabindex="-1"><a class="header-anchor" href="#_18" aria-hidden="true">#</a> 18. %</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 这里，还可以用一个 %s 来替代。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="作业优化上节课的作业" tabindex="-1"><a class="header-anchor" href="#作业优化上节课的作业" aria-hidden="true">#</a> 作业优化上节课的作业</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"正在生成您的简历......"</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"**************************"</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"      简历       "</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment">###用% 实现</span>
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"正在生成您的简历......"</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"**************************"</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"      简历       "</span><span class="token punctuation">)</span>
name<span class="token operator">=</span><span class="token string">"黄家宝"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_19-保留小数点" tabindex="-1"><a class="header-anchor" href="#_19-保留小数点" aria-hidden="true">#</a> 19. 保留小数点</h2>
<ul>
<li><a href="https://bornforthis.cn/column/py/basequestion/radix_point.html" target="_blank" rel="noopener noreferrer">https://bornforthis.cn/column/py/basequestion/radix_point.html<ExternalLinkIcon/></a></li>
</ul>
<p>这里就是 1.23456 乘以了 1000 之后，被 int 截掉了 ， 变成了  1234， 然后再除以 1000 ， 所以答案 变成 ： 1.234</p>
